<!--<div class="container pt-5">
    ...
    <a href="<?= base_url('dokter/export/');?>" class="btn btn-success mb-2">Export to Excel</a>-->
    <!-- <br><br> -->
        <!-- <div class="container align-items-center">
                <form action="<?= base_url('dokter/export/');?>" method="POST">
                    <div class="row">
    ...
    <div class="card">
        <div class="card-header bg-info text-white">
            <h4 class="card-title">Laporan Antrian</h4>
        </div>
        <div class="card-body">
