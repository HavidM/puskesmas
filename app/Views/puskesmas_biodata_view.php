...
<html lang="en">
   ...
   <body>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="row">
               <form method="post" accept-charset="utf-8" action="<?= base_url('puskesmas/updatebiodata');?>">
                     <div class="form-group">
                        <label for="nik">NIK</label>
                        <input type="text" value="<?= session()->get('NIK');?>" name="nik" required class="form-control">
                     </div>
                     <div class="form-group">
                        <label for="nama">NAMA</label>
                        <input type="text" value="<?= $nama;?>" name="nama" required class="form-control">
                     </div>
                     <div class="form-group">
                        <label for="password">PASSWORD</label>
                        <input type="text" value="<?= $password;?>" name="password" required class="form-control">
                     </div>
                     <label for="kelamin">JENIS KELAMIN</label>
                     <div class="form-group">
                        <select class="form-control" name="kelamin">
                           <?php foreach($getjeniskelamin as $kelamin):?>
                              <option value="<?= $kelamin->KETERANGAN?>"
                                    <?php if ($kelamin->KETERANGAN == $jeniskelamin) : ?> selected<?php endif; ?>>
                                    <?= $kelamin->KETERANGAN?>
                              </option>
                           <?php endforeach; ?>
                        </select>
                     ...
                     <div class="form-group">
                        ...
                        <input type="textarea" value="<?= $alamat;?>" name="alamat" required class="form-control">
                     </div>
                     <div class="form-group">
                        <label for="tanggal_lahir">TANGGAL LAHIR</label>
                        <input type="date" value="<?= $tgllahir;?>" name="tanggal_lahir" required class="form-control">
                     </div>
