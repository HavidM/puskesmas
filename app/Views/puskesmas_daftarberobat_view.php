...
<html lang="en">
   ...
   <body>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="row">
                <form method="post" accept-charset="utf-8" action="<?= base_url('puskesmas/konfirmasiftarberobat');?>">
                     <div class="form-group">
                     
                            <select required name="ddpoli">
                            <option value="" enabled diselected>-- Pilih Poli --</option>
                            <?php                                
