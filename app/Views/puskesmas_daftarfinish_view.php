...
<html lang="en">
   ...
   <body>
      ...
      <div class="about_section layout_padding">
         <div class="container">
         <label style="color:green">Anda berhasil mendaftar dengan data sebagai berikut :</label><br><br><br>
            <div class="row">
                <div class="form-group">
                    <label for="nama">NAMA</label>
                    <input type="text" value="<?= $getNama;?>" name="nama" required class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label for="poli">Poli yang di tuju</label>
                    <input type="text" value="<?= $getPoli;?>" name="poli" required class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label for="noantrian">No Antrian</label>
                    <input type="text" value="<?= $getNoAntrian;?>" name="noantrian" required class="form-control" readonly>
                </div>
            </div>
         </div>
      </div>
